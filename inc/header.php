 ...
 *
 * Requisito: db.php y auth.php deben haberse cargado antes (o al menos session_start).
 * El archivo agrega automáticamente <link> de theme.css y header.css.
 */

if (session_status() !== PHP_SESSION_ACTIVE) session_start();

// ── Detectar BASE URL automáticamente ────────────────────────────────────────
// __DIR__ es la carpeta /inc/. Su padre es la raíz de la app.
...
// Ej: si la app está en htdocs/coltauco/ → $_gh_base = '/coltauco'
// Si está en htdocs/ directamente       → $_gh_base = ''
...
$_gh_rut      = !empty($_SESSION['rut'])            ? (string)$_SESSION['rut']         : '';
$_gh_is_admin = !empty($_SESSION['is_superadmin'])  && (int)$_SESSION['is_superadmin'] === 1;
$_gh_logged   = $_gh_fid > 0;

// ── Permiso módulo Horas (sin query extra si no está logeado) ─────────────────
$_gh_horas = false;
...
<header class="gh-bar" id="ghBar">
    ...
    <nav class="gh-nav" id="ghNav">
      ...
      <div class="gh-group<?php echo _gh_active(array('/actividades', '/marcaciones/mi', '/solicitud_horas', '/horarios_horas', '/reservar_horas', '/estado_horas')); ?>">
        <button class="gh-nav-btn" type="button">
          ...
          Mi espacio
          <svg class="gh-chev" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
      ...
      <div class="gh-group gh-group--admin<?php echo _gh_active(array('/admin/')); ?>">
        ...
        <div class="gh-drop gh-drop--wide">
          ...
          <div class="gh-drop-label">Usuarios y estructura</div>
          ...
          <a class="gh-drop-item<?php echo _gh_active(array('/direcciones_list')); ?>" href="<?php echo $_gh_base; ?>/admin/direcciones_list.php">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
              <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/>
              <polyline points="9 22 9 12 15 12 15 22"/>
            </svg>
          ...
          <a class="gh-drop-item<?php echo _gh_active(array('/unidades_list')); ?>" href="<?php echo $_gh_base; ?>/admin/unidades_list.php">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
          ...
          <a class="gh-drop-item<?php echo _gh_active(array('/cargos_list')); ?>" href="<?php echo $_gh_base; ?>/admin/cargos_list.php">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
              <circle cx="12" cy="8" r="4"/><path d="M6 20v-2a6 6 0 0 1 12 0v2"/>
            </svg>
            Cargos
          </a>
          <a class="gh-drop-item<?php echo _gh_active(array('/rol_permisos')); ?>" href="<?php echo $_gh_base; ?>/admin/rol_permisos.php">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round">
  ...
  <div class="gh-mob-menu" id="ghMobMenu">
    ...
    <div class="gh-mob-sect">
      ...
      <a class="gh-mob-item" href="<?php echo $_gh_base; ?>/admin/horas_config.php">Configuración</a>
    </div>
    <?php endif; ?>
    ...
    <div class="gh-mob-sect">
      ...
      <a class="gh-mob-item" href="<?php echo $_gh_base; ?>/admin/users_form.php">Crear usuario</a>
...
(function () {
  ...
  var bar       = document.getElementById('ghBar');
  ...
  /* Dropdowns de escritorio → clic en botón */
